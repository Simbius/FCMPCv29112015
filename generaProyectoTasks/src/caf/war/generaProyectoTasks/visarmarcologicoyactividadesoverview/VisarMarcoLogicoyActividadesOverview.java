...
@ManagedBean(name = "VisarMarcoLogicoyActividadesOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "VisarMarcoLogicoyActividadesOverview", beanType = BeanType.PORTLET)
public class VisarMarcoLogicoyActividadesOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public VisarMarcoLogicoyActividadesOverview() {
