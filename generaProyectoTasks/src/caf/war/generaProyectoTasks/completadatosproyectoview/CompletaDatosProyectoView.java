...
@ManagedBean(name = "CompletaDatosProyectoView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CompletaDatosProyectoView", beanType = BeanType.PORTLET)
public class CompletaDatosProyectoView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public CompletaDatosProyectoView() {
