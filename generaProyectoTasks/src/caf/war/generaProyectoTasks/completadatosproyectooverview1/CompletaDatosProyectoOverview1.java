...
@ManagedBean(name = "CompletaDatosProyectoOverview1")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CompletaDatosProyectoOverview1", beanType = BeanType.PORTLET)
public class CompletaDatosProyectoOverview1  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public CompletaDatosProyectoOverview1() {
