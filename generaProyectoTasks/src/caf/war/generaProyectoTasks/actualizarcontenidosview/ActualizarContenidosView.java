...
@ManagedBean(name = "ActualizarContenidosView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ActualizarContenidosView", beanType = BeanType.PORTLET)
public class ActualizarContenidosView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public ActualizarContenidosView() {
