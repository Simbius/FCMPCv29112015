 ...
 * IS document wrapper
 */
public  class SFCMPC_docs_marcoLogicoV2 extends java.lang.Object implements Serializable {

	
	private static final long serialVersionUID = 1L;
	// IS Document type used to generate this class
	public static final String DOCUMENT_TYPE = "sFCMPC.docs:marcoLogicoV2";
	...
	private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Establecimientos[] establecimientos = null;
	private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Objetivo[] objetivo = null;
	private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos[] objetivosEspecificos = null;
	private java.lang.String aprobadoML;
	public static String[][] FIELD_NAMES = new String[][] {{"nombrePro", "nombrePro"},{"periodo", "periodo"},{"fechaDesde", "fechaDesde"},{"fechaHasta", "fechaHasta"},{"encargado", "encargado"},{"planta", "planta"},{"comuna", "comuna"},{"objetivoGeneral", "ObjetivoGeneral"},{"establecimientos", "establecimientos"},{"objetivo", "objetivo"},{"objetivosEspecificos", "objetivosEspecificos"},{"aprobadoML", "aprobadoML"},{"observacionesML", "observacionesML"},
	};
	private java.lang.String observacionesML;
	

	public SFCMPC_docs_marcoLogicoV2() {
	}
	 ...
	 * IS document wrapper
	 */
	public static class Establecimientos extends java.lang.Object implements Serializable {
	
		
		private static final long serialVersionUID = 1L;
		private java.lang.String establecimiento;
		public static String[][] FIELD_NAMES = new String[][] {{"establecimiento", "establecimiento"},{"profesionales", "profesionales"},
		};
	...
	public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Establecimientos[] getEstablecimientos()  {
	...
	public void setEstablecimientos(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Establecimientos[] establecimientos)  {
	...
	public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Objetivo[] getObjetivo()  {
		if (objetivo == null) {
			//TODO: create/set default value here
		}
		return objetivo;
	...
	public void setObjetivo(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.Objetivo[] objetivo)  {
	...
	public static class ObjetivosEspecificos extends java.lang.Object implements Serializable {
		...
		private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Especificos[] especificos = null;
		...
		private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia[] estrategia = null;
		...
		public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Especificos[] getEspecificos()  {
			if (especificos == null) {
				//TODO: create/set default value here
			}
			return especificos;
		...
		public void setEspecificos(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Especificos[] especificos)  {
		...
		public static class Estrategia extends java.lang.Object implements Serializable {
			...
			private caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia.Ciclo[] ciclo = null;
			...
			public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia.Ciclo[] getCiclo()  {
				if (ciclo == null) {
					//TODO: create/set default value here
				}
				return ciclo;
			...
			public void setCiclo(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia.Ciclo[] ciclo)  {
				this.ciclo = ciclo;
			}
		...
		public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia[] getEstrategia()  {
			if (estrategia == null) {
				//TODO: create/set default value here
			}
			return estrategia;
		...
		public void setEstrategia(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos.Estrategia[] estrategia)  {
	...
	public caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos[] getObjetivosEspecificos()  {
	...
	public void setObjetivosEspecificos(caf.war.generaProyectoTasks.is.document.SFCMPC_docs_marcoLogicoV2.ObjetivosEspecificos[] objetivosEspecificos)  {
