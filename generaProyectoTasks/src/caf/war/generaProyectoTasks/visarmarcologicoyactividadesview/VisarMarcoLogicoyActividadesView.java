...
@ManagedBean(name = "VisarMarcoLogicoyActividadesView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "VisarMarcoLogicoyActividadesView", beanType = BeanType.PORTLET)
public class VisarMarcoLogicoyActividadesView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public VisarMarcoLogicoyActividadesView() {
