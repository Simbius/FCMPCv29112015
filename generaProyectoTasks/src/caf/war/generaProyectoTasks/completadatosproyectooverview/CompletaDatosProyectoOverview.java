...
@ManagedBean(name = "CompletaDatosProyectoOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CompletaDatosProyectoOverview", beanType = BeanType.PORTLET)
public class CompletaDatosProyectoOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public CompletaDatosProyectoOverview() {
