...
@ManagedBean(name = "CompletaDatosProyectoView1")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CompletaDatosProyectoView1", beanType = BeanType.PORTLET)
public class CompletaDatosProyectoView1  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public CompletaDatosProyectoView1() {
