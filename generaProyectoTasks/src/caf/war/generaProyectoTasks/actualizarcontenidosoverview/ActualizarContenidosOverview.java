...
@ManagedBean(name = "ActualizarContenidosOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ActualizarContenidosOverview", beanType = BeanType.PORTLET)
public class ActualizarContenidosOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public ActualizarContenidosOverview() {
