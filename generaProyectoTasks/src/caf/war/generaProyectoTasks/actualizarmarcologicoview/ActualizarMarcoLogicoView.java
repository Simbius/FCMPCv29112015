 ...
 * 
 */
package caf.war.generaProyectoTasks.actualizarmarcologicoview;
...
@ManagedBean(name = "ActualizarMarcoLogicoView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ActualizarMarcoLogicoView", beanType = BeanType.PORTLET)
public class ActualizarMarcoLogicoView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.generaProyectoTasks.GeneraProyectoTasks generaProyectoTasks = null;
	/**
	 ...
	 */
	public ActualizarMarcoLogicoView() {
	...
	public caf.war.generaProyectoTasks.GeneraProyectoTasks getGeneraProyectoTasks()  {
		if (generaProyectoTasks == null) {
		    generaProyectoTasks = (caf.war.generaProyectoTasks.GeneraProyectoTasks)resolveExpression("#{GeneraProyectoTasks}");
		}
		return generaProyectoTasks;
	}
