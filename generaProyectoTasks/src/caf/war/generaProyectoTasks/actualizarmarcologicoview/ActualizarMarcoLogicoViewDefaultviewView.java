...
@ManagedBean(name = "ActualizarMarcoLogicoViewDefaultviewView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ActualizarMarcoLogicoView/default", beanType = BeanType.PAGE)
public class ActualizarMarcoLogicoViewDefaultviewView extends com.webmethods.caf.faces.bean.task.BaseTaskDetailsPageBean {
	...
	private static final String[][] TASKDISPLAYPROVIDER_PROPERTY_BINDINGS = new String[][] {
		{"#{TaskDisplayProvider.taskID}", "#{ActualizarMarcoLogicoView.taskID}"},
	};
	...
	public String cancelView() {
		try {
			...
			String url = getActualizarMarcoLogicoView().getFinishUrl();
	...
	public String completeTask() {
		try {
			if( !getActualizarMarcoLogico().isUpdateable() ){
			...
			// do the work
			getActualizarMarcoLogico().completeTask(); 
	...
	public String submitTask() {
		try {
			...
			// do the work
			getActualizarMarcoLogico().applyChanges();
		} catch (Exception e) {
			error(e);
			log(e);
		}
	...
	public String assignToPrincipals() {
		try {
			...
			TaskContentProvider tp = getActualizarMarcoLogico();
	...
	private static final String[][] INITIALIZE_PROPERTY_BINDINGS = new String[][] {
		{"#{ActualizarMarcoLogico.reset}", null}
	};
	private transient caf.war.generaProyectoTasks.actualizarmarcologicoview.ActualizarMarcoLogicoView actualizarMarcoLogicoView = null;
	...
	private static final String[][] ACTUALIZARMARCOLOGICO_PROPERTY_BINDINGS = new String[][] {
		{"#{ActualizarMarcoLogico.taskID}", "#{ActualizarMarcoLogicoView.taskID}"},
		{"#{ActualizarMarcoLogico.autoAccept}", "true"},
		{"#{ActualizarMarcoLogico.adhocRouting}", "false"},
	};
	...
	public caf.war.generaProyectoTasks.actualizarmarcologicoview.ActualizarMarcoLogicoView getActualizarMarcoLogicoView()  {
		if (actualizarMarcoLogicoView == null) {
		    actualizarMarcoLogicoView = (caf.war.generaProyectoTasks.actualizarmarcologicoview.ActualizarMarcoLogicoView)resolveExpression("#{ActualizarMarcoLogicoView}");
		}
		return actualizarMarcoLogicoView;
	}
