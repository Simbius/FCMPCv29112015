...
@ManagedBean(name = "ActualizarMarcoLogicoOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ActualizarMarcoLogicoOverview", beanType = BeanType.PORTLET)
public class ActualizarMarcoLogicoOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public ActualizarMarcoLogicoOverview() {
