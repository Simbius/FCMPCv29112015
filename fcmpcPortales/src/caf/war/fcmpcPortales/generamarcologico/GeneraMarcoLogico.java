...
public class GeneraMarcoLogico  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 * 3) Fall back to the PortletPreferences
	 */
	public String getIndicaDor() throws Exception {
		return (String) getPreferenceValue("indicaDor", String.class);
	}
	...
	public void setIndicaDor(String indicaDor) throws Exception {
		setPreferenceValue("indicaDor", indicaDor);
	}
}