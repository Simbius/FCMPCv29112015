...
@ManagedBean(name = "AprobarMarcodelProyectoV2Overview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "AprobarMarcodelProyectoV2Overview", beanType = BeanType.PORTLET)
public class AprobarMarcodelProyectoV2Overview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public AprobarMarcodelProyectoV2Overview() {
