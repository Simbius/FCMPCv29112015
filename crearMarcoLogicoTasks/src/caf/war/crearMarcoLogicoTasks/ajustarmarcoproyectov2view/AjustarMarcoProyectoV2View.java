...
@ManagedBean(name = "AjustarMarcoProyectoV2View")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "AjustarMarcoProyectoV2View", beanType = BeanType.PORTLET)
public class AjustarMarcoProyectoV2View  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public AjustarMarcoProyectoV2View() {
