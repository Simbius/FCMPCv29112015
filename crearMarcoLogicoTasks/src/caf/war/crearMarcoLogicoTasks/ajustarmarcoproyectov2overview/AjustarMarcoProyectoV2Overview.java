...
@ManagedBean(name = "AjustarMarcoProyectoV2Overview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "AjustarMarcoProyectoV2Overview", beanType = BeanType.PORTLET)
public class AjustarMarcoProyectoV2Overview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public AjustarMarcoProyectoV2Overview() {
