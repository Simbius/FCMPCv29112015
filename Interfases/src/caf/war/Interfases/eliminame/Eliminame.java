...
@ManagedBean(name = "Eliminame")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "eliminame", beanType = BeanType.PORTLET)
public class Eliminame  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
