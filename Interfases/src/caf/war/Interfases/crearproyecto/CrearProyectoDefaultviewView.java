...
public class CrearProyectoDefaultviewView  extends   com.webmethods.caf.faces.bean.BasePageBean {
	...
	private transient caf.war.Interfases.crearproyecto.CrearProyecto crearProyecto = null;
	...
	public caf.war.Interfases.crearproyecto.CrearProyecto getCrearProyecto()  {
		if (crearProyecto == null) {
		    crearProyecto = (caf.war.Interfases.crearproyecto.CrearProyecto)resolveExpression("#{CrearProyecto}");
		}
