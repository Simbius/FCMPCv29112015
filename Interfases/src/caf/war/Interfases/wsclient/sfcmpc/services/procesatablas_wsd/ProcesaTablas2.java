 ...
 */
@ManagedBean(name = "ProcesaTablas2")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(beanType = BeanType.DEFAULT)
public class ProcesaTablas2 extends com.webmethods.caf.faces.data.ws.wss.WSSContentProvider {

	private static final long serialVersionUID = 783461675435396096L;
	
	/**
	 * Constructor
	 */
	public ProcesaTablas2() {
	...
	public class Parameters implements Serializable {
		...
		private static final long serialVersionUID = 2792528884214333440L;
