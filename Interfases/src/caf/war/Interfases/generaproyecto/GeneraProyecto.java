...
@ManagedBean(name = "GeneraProyecto")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "GeneraProyecto", beanType = BeanType.PORTLET)
public class GeneraProyecto  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
